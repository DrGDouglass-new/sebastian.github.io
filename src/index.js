...
export function index(){
    ...
    $('body').append(`
        <div class="promoBar">
            <span class="left">
                <h1><span class="has-text-warning">${egg15.length > 0 ? `Ev${egg15}lve` : `Evolve`}</span>
                <a href="https://github.com/wdjwxh/Evolve-Scripting-Edition/blob/master/README.md" target="_blank">
                    Unsupported Scripting Edition
                </a>
                </h1>
            </span>
            <span class="right">
                ...
                <a href="https://shimo.im/sheets/tg6VPQgCKhrYW9QG/" target="_blank" style="color: green;">最全中文Wiki</a>
                |<a href="wiki.html" target="_blank">Wiki</a> 
                |<a href="https://pmotschmann.github.io/Evolve/" target="_blank">Original Evolve Idle Game</a> 
                |<a href="https://github.com/pmotschmann/Evolve" target="_blank">Demagorddon GitHub</a> 
                <a href="https://www.patreon.com/demagorddon" target="_blank">Demagorddon Patreon</a> 
                <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=PTRJZBW9J662C&currency_code=USD&source=url" target="_blank">Donate to Demagorddon</a>
                </ul>
            </span>
        </div>
    `);
